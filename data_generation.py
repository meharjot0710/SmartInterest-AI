...
data = {
    ...
    'Operating System': np.random.randint(25, 101, num_rows),
    'DSA': np.random.randint(25, 101, num_rows),
    'Frontend': np.random.randint(25, 101, num_rows),
    'Backend': np.random.randint(25, 101, num_rows),
    'Machine Learning': np.random.randint(25, 101, num_rows),
    'Data Analytics': np.random.randint(25, 101, num_rows),
